...
export const BLOCK_TYPES = [
  ...
  { type: 'stats', label: 'Stats', defaults: { heading: '', items: [] } },            // item: {value, suffix, label}
  { type: 'testimonials', label: 'Testimonials', defaults: { heading: '', items: [] } }, // item: {quote, name, role, avatar}
  { type: 'team', label: 'Team grid', defaults: { heading: '', subheading: '', members: [] } }, // member: {name, designation, image, url}
  { type: 'logos', label: 'Logo marquee', defaults: { heading: '', logos: [] } },      // logo: {image, alt}
];
