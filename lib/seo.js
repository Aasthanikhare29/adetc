...
export const SITE = {
  ...
  description:
    'Ad Etc Studios is a full-service film and video production company in Ahmedabad, delivering ad films, brand videos, TVCs and post-production with bold visuals and powerful storytelling.',
...
export function pageMetadata({ title, description, path = '/', image } = {}) {
  ...
  if (title) meta.title = title; // string title → layout template adds "| Ad Etc Studios"
  return meta;
}
