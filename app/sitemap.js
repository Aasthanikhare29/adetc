...
const ROUTES = [
  ...
  '/project-detail/cure-sight-laser-center',
  '/project-detail/vijeta-kaun',
  '/project-detail/chor-police',
  '/project-detail/swayam-bhagwan',
  '/project-detail/ye-saaf-hai',
  '/project-detail/khushiyon-ka-pakka-vaada',
  '/project-detail/ms-bose',
  '/project-detail/health-aapki-zimmedari-hamari',
  '/project-detail/sirf-tere-liye',
  '/blog',
  '/team',
  '/testimonial',
  '/pricing',
