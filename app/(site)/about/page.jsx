            ...
            <div className="about-circle-logo-container">
              <div className="about__circle-logo">
                <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="circleLogoTitle">
                  ...
                  <text dy="5">
                                      <textPath href="#textcircle" className="about__circle-logo-title" startOffset="0%">• Ad Etc Studios FILM AND VIDEO PRODUCTION STUDIO • BRINGING IDEAS TO LIFE ON SCREEN</textPath>
                  </text>
