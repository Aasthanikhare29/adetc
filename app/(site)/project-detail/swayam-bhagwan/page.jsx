...
const PATH = '/project-detail/swayam-bhagwan';
const DESCRIPTION =
  'A short-format advertising film for Cure Sight Laser Center using humour and a larger-than-life visual character to communicate the importance of clear vision — produced by AdEtc Studios.';

export const metadata = pageMetadata({
  title: 'Cure Sight Laser Center - Swayam Bhagwan',
    ...
    <div className="hero-container">
      <div className="project-detail-content-container">
        <div className="project-detail-video-container">
                  <div className="project-video-bg" data-video-id="wyoMwNQcC2w" id="video-bg-1"></div>
                  <div className="project-detail-video-spacer"></div>
        </div>
        <div className="row row-cols-lg-2 row-cols-1 grid-spacer-80">
          <div className="col col-lg-5">
            <div className="heading-container">
                          <h2>Swayam Bhagwan</h2>
            </div>
          </div>
          <div className="col col-lg-7">
            <div className="d-flex flex-column gspace-2 justify-content-end h-100">
                          <h3>About the Project</h3>
                          <p>A short-format advertising film for Cure Sight Laser Center that uses humour and a larger-than-life visual character to communicate the importance of clear vision and professional eye care.</p>
            </div>
          </div>
        </div>
        <div className="row row-cols-lg-2 row-cols-1 grid-spacer-80">
          ...
          <div className="col col-lg-8">
            <div className="d-flex flex-column gspace-2">
              ...
              <div className="row row-cols-lg-3 row-cols-1 grid-spacer-2">
                ...
                <div className="col">
                  <div className="card card-project-detail">
                                      <h5>Character Styling & Visual Execution</h5>
                  </div>
                </div>
                <div className="col">
                  <div className="card card-project-detail">
        ...
        <div className="row row-cols-lg-2 row-cols-1 grid-spacer-80">
          ...
          <div className="col col-lg-8">
                      <p>The film begins with a woman experiencing difficulty with her eyes, setting up an everyday and relatable problem. The situation then takes a playful turn when a larger-than-life, almost divine character appears, creating a humorous visual metaphor around her vision.</p>
                      <p>The contrast between the everyday setting and the surreal character gives the film an entertaining tone while leading naturally to the Cure Sight Laser Center brand and its focus on better vision.</p>
          </div>
        </div>
      </div>
    </div>
