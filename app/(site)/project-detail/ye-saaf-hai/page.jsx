...
const PATH = '/project-detail/ye-saaf-hai';
const DESCRIPTION =
  'A short-format advertising film for Pollie Kitchen Cleaner built around an everyday kitchen situation to highlight cleaning performance and pleasant fragrance — produced by AdEtc Studios.';

export const metadata = pageMetadata({
  title: 'Pollie Kitchen Cleaner - Ye Saaf Hai?',
  ...
  <section className="section banner-inner project-detail-banner">
    ...
    <div className="hero-container">
      <div className="banner-inner-container">
              <h2>Pollie Kitchen Cleaner</h2>
        <nav className="breadcrumb">
                  <a href="/" className="breadcrumb-item">Home</a>
                  <span className="separator">/</span>
                  <a href="/project" className="breadcrumb-item">Portfolio</a>
                  <span className="separator">/</span>
                  <span className="breadcrumb-item current">Pollie Kitchen Cleaner</span>
        </nav>
      </div>
    </div>
  </section>
    ...
    <div className="hero-container">
      <div className="project-detail-content-container">
        <div className="project-detail-video-container">
                  <div className="project-video-bg" data-video-id="z3G3d2CPWFM" id="video-bg-1"></div>
        ...
        <div className="row row-cols-lg-2 row-cols-1 grid-spacer-80">
          ...
          <div className="col col-lg-7">
            <div className="d-flex flex-column gspace-2 justify-content-end h-100">
                          ...
                          <p>A short-format advertising film for Pollie Kitchen Cleaner, built around an everyday kitchen situation to highlight the product's cleaning performance along with its pleasant fragrance.</p>
            </div>
          </div>
        </div>
        <div className="row row-cols-lg-2 row-cols-1 grid-spacer-80">
          <div className="col col-lg-4">
            <div className="card card-project-detail">
                          <h5>Client: Pollie Kitchen Cleaner</h5>
                          <h5>Industry: Home Care / Cleaning Products</h5>
        ...
        <div className="row row-cols-lg-2 row-cols-1 grid-spacer-80">
          ...
          <div className="col col-lg-8">
                      <p>The film uses a character-driven setup and visual reactions to create curiosity around what is happening in the kitchen. The interaction between the characters leads naturally to the product reveal, while the final communication highlights a key differentiator of Pollie: it cleans and smells good.</p>
                      <p>The film closes with the brand message "Pollie – And It Smells Good," reinforcing the fragrance benefit alongside the product's core cleaning proposition.</p>
          </div>
        </div>
      </div>
    </div>
