...
const PATH = '/project-detail/ms-bose';
const DESCRIPTION =
  'A short-format advertising film for Cure Sight Laser Center communicating the importance of better vision through a simple, relatable everyday situation — produced by AdEtc Studios.';

export const metadata = pageMetadata({
  title: 'Cure Sight Laser Center - Ms. Bose',
    ...
    <div className="hero-container">
      <div className="project-detail-content-container">
        <div className="project-detail-video-container">
                  <div className="project-video-bg" data-video-id="tlapIbTVRnQ" id="video-bg-1"></div>
        ...
        <div className="row row-cols-lg-2 row-cols-1 grid-spacer-80">
          ...
          <div className="col col-lg-7">
            <div className="d-flex flex-column gspace-2 justify-content-end h-100">
                          ...
                          <p>A short-format advertising film created for Cure Sight Laser Center to communicate the importance of better vision through a simple, relatable everyday situation.</p>
            </div>
          </div>
        </div>
        <div className="row row-cols-lg-2 row-cols-1 grid-spacer-80">
        ...
        <div className="row row-cols-lg-2 row-cols-1 grid-spacer-80">
          ...
          <div className="col col-lg-8">
                      <p>The film uses a light, slice-of-life approach to show how vision can affect everyday experiences. A playful interaction between characters creates the setup, while the visual storytelling keeps the communication simple and relatable.</p>
                      <p>The film then connects the situation to Cure Sight Laser Center with the message "For Better Sight, Just Cure Sight," bringing the brand into the story naturally rather than relying on a conventional medical advertisement.</p>
          </div>
        </div>
      </div>
    </div>
